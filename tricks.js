		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function(value) {
				...
				if(Lampa.Storage.field('CustomScreenSaver') == true) {
					...
					Lampa.Storage.set ('screensaver_aerial_items', '[{"id":"","accessibilityLabel":"","src":{"H2641080p":"https://nypmhick.github.io/lampa_plugins/screensaver/Fire.mp4"},"name":"","pointsOfInterest":{"0":""},"type":"","timeOfDay":""}]');
				/*
